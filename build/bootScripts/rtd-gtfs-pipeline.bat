...
set JARPATH=%APP_HOME%\lib\rtd-gtfs-pipeline-1.0-SNAPSHOT.jar

@rem Execute rtd-gtfs-pipeline
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %RTD_GTFS_PIPELINE_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%RTD_GTFS_PIPELINE_EXIT_CONSOLE%" exit 1
exit /b 1
